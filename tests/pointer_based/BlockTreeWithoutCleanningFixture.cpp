...
class BlockTreeWithoutCleanningFixture : public ::testing::TestWithParam<::testing::tuple<int, int, std::string>> {
protected:
...
public:
    ...
    BlockTreeWithoutCleanningFixture() : ::testing::TestWithParam<::testing::tuple<int, int, std::string>>() {
